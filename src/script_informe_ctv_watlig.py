...
# Generated from .ipynb template: ctv_watlig.ipynb
# www.github.com/ismailuddin/jupyter-nb-templater/
# Generated on: 2022-04-13 18:14 
...
for i in 1:12
    ...
    sym_watlig_phs = Symbol("watlig_dist_", PH)
    eval(:($sym_watlig_phs = watlig_phs))
end
""".strip()
...
min_dist = 0
max_dist = 10
plot(collect(1:nstlim) ./ 100, watlig_dist_""" + str(ph) + r""",
    title = string("N1 distance to closest water - pH = ", """ + str(PH) + r"""), size = (750, 400),
...
wgh_watlig = fill(1.0, length(watlig_dist_""" + str(ph) + r"""))

# Histograma ponderado
Wbins_watlig, Whis_watlig = JUMD.weightedHist(watlig_dist_""" + str(ph) + r""", bin_watlig, wgh_watlig, true, false);
...
bar(Wbins_watlig, Whis_watlig,
    ...
    guidefont = font(18, "Arial"), tickfont = font(12, "Arial"),
    legendfont = font(12, "Arial"),
    title = string("Histogram of N1 distance to closest water - pH = ", """ + str(PH) + r"""),
...
for ph in range(20, 80, 5):
    if ph == 75:
        ...
        [ mean(watlig_dist_""" + str(ph) + r""") std(watlig_dist_""" + str(ph) + r""") std(watlig_dist_""" + str(ph) + r""") / mean(watlig_dist_""" + str(ph) + r""") ])""").strip() + "\n" + "\n"
        break
...
nbf.write(nb, r'/home/pbarletta/labo/20/reobp/src/informe_ctv_watlig.ipynb')
print(r"Jupyter notebook /home/pbarletta/labo/20/reobp/src/informe_ctv_watlig.ipynb successfully generated.")
