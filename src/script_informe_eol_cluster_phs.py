...
for ph in range(30, 80, 5):
    ...
    celda_ph_1=(r"""viewstruc(read(joinpath(dir_eol_clu,  string(phs[""" + str(i) + r"""], "ph"), "top_cluster.c0.pdb"), PDB))""").strip()
    celda_ph_2=(r"""viewstruc(read(joinpath(dir_eol_clu,  string(phs[""" + str(i) + r"""], "ph"), "top_cluster.c1.pdb"), PDB))""").strip()
    celda_ph_3=(r"""viewstruc(read(joinpath(dir_eol_clu,  string(phs[""" + str(i) + r"""], "ph"), "top_cluster.c2.pdb"), PDB))""").strip()
...
nbf.write(nb, r'/home/pbarletta/labo/20/cph_obp/src/informe_eol_cluster_phs.ipynb')
print(r"Jupyter notebook /home/pbarletta/labo/20/cph_obp/src/informe_eol_cluster_phs.ipynb successfully generated.")
