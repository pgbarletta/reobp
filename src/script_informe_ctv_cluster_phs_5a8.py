...
i = 6
for ph in range(50, 80, 5):
    PH = ph / 10
    i += 1
    celda_titulo=(r"""#### ph = """ + str(PH)).strip()
    celda_ph_1=(r"""viewstruc(read(joinpath(dir_ctv_clu,  string(phs[""" + str(i) + r"""]), "top_cluster_""" + str(PH) + r""".c0.pdb"), PDB))""").strip()
    celda_ph_2=(r"""viewstruc(read(joinpath(dir_ctv_clu,  string(phs[""" + str(i) + r"""]), "top_cluster_""" + str(PH) + r""".c1.pdb"), PDB))""").strip()
    celda_ph_3=(r"""viewstruc(read(joinpath(dir_ctv_clu,  string(phs[""" + str(i) + r"""]), "top_cluster_""" + str(PH) + r""".c2.pdb"), PDB))""").strip()
...
nbf.write(nb, r'/home/pbarletta/labo/20/cph_obp/src/informe_ctv_cluster_phs_5a8.ipynb')
print(r"Jupyter notebook /home/pbarletta/labo/20/cph_obp/src/informe_ctv_cluster_phs_5a8.ipynb successfully generated.")
