...
for idx in range(1, 11):
    ...
    celda_idx_1 = (r"""viewstruc(read(joinpath(dir_apo_clu, string(idx[""" + str(idx) + r"""]), "top_cluster.c0.pdb"), PDB))""").strip()
    celda_idx_2 = (r"""viewstruc(read(joinpath(dir_apo_clu, string(idx[""" + str(idx) + r"""]), "top_cluster.c1.pdb"), PDB))""").strip()
    celda_idx_3 = (r"""viewstruc(read(joinpath(dir_apo_clu, string(idx[""" + str(idx) + r"""]), "top_cluster.c2.pdb"), PDB))""").strip()
    nb['cells'].append(nbf.v4.new_markdown_cell(celda_titulo))
...
nbf.write(nb, r'/home/pbarletta/labo/20/cph_obp/src/informe_apo_cluster_idx.ipynb')
print(r"Jupyter notebook /home/pbarletta/labo/20/cph_obp/src/informe_apo_cluster_idx.ipynb successfully generated.")
